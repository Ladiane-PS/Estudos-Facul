...
class ClientHandler extends Thread {
    ...
    private ChatMessage chatServer;
    ...
    public void run() {
        try {
            ...
            while (isConnected) {
                ...
                ChatMessage.broadcast(username + ": " + message, this);
                
            }
            notifyConnection("left");
            ChatMessage.removeClient(this);
            clientSocket.close();
    ...
    public void notifyConnection(String status) {
        ...
        ChatMessage.broadcast(message, this);
